    ...
    >
      ...
      <div className="flex items-center gap-3 p-3">
        ...
        >
          <div className="flex items-center gap-2 mb-0.5">
            <h3
              className={`font-bold text-sm leading-snug transition-colors duration-200 ${
                checked ? "text-white/35 line-through decoration-white/20" : "text-white hover:text-amber-300"
              }`}
            >
              {arc.name}
            </h3>
          ...
          <p className="text-[11px] text-white/35 font-mono mb-1">Ep {arc.episodes}</p>
